                        ...
                        <View style={styles.menuList}>
                            {
                                userInfor.user_permission === 4 ?
                                    ...
                                    <>
                                        ...
                                        <Menu onTab={() => navigate('Ordered')} icon="inbox" title="Quản lý đơn hàng" description="Quản lý các sản phẩm người dùng đã đặt" />
                                        <Menu onTab={() => navigate('ManagerReport')} icon="warning" title="Quản lý báo cáo" description="Quản lý các report của khách hàng" />
                                        <Menu onTab={() => navigate('AddUser')} icon="sharealt" title="Cấp tài khoản" description="Cấp tài khoản admin hoặc ship" />
